...
<%
	...
	MemberVO foundID = new MemberVO();
	foundID = memberdao.findID(name, email);
...
<body>
	<div class="login-card">
		<%
			if (foundID.getId() != null) {
		%>	
				<%= name %>님의 아이디는 <b><%= foundID.getId() %></b>입니다.<p>
		...
		%>
				이름 또는 이메일 주소가 틀렸습니다.<p>
				<a href="findID.jsp"><input type="button" class="login login-submit" value="다시 입력하기"></a>
		<%
			}
		%>	
